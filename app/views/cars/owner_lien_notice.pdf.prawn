prawn_document() do |pdf|
  ...
  pdf.draw_text "X", :at => [22, 625]
  pdf.draw_text @car.owner_name, :at => [35, 600]
  pdf.draw_text @car.owner_address, :at => [45, 570]
  pdf.draw_text "#{@car.owner_city}, #{@car.owner_state}, #{@car.owner_zip}", :at => [120, 540] if @car.owner_city and @car.owner_state and @car.owner_zip
