prawn_document(margin: [15,15,15,15], page_layout: :landscape) do |pdf|
  ...
  while x < @cars.count
    ...
    cars.each_with_index do |car, i|
      ...
      pdf.text_box car.size, width: 30, height: 28, at: [353, 384 - i * row_height], align: :center, valign: :center
      #TODO What to do with MVD Inquiry?
      pdf.text_box "#{car.owner_name}, #{car.owner_address}", width: 148, height: 28, at: [442, 384 - i * row_height], align: :center, valign: :center
