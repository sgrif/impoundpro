...
User.create(email: 'sgriffin@griffinassoc.com', password: 'password', name: 'Griffin & Associates', address: '119 Dartmouth SE', city: 'Albuquerque', state: 'NM', zip: '87106', county: 'Bernalillo')
User.create(email: 'ferret4prez@gmail.com', password: 'password', name: 'Griffin & Associates', address: '119 Dartmouth SE', city: 'Albuquerque', state: 'NM', zip: '87106', county: 'Bernalillo')

Car.create(year: 2008, make: 'Saturn', model: 'Aura', size: '4-Door', color: 'Blue', state: 'NM', vin: '1G3JFYR7389E11374', license_plate_number: 'LGG767', date_towed: '2012-01-26 20:57:00 UTC', tow_requested_by: 'test_tow_requested_by', tow_reason: 'test_tow_reason', mail_notice_of_lien_date: '2012-01-26 20:57:00 UTC', has_registered_owner: true, owner_name: 'Tyler Rodriguez', owner_address: 'PO Box 91252', owner_city: 'Albuquerque', owner_state: 'NM', owner_zip: '87199', has_lien_holder:true, lien_holder_name: 'test_lien_holder_name', lien_holder_address: 'test_lien_holder_address', lien_holder_city: 'test_lien_holder_city', lien_holder_state: 'test_lien_holder_state', lien_holder_zip: 'test_lien_holder_zip', driver_name: 'driver_name', driver_address: 'driver_address', driver_city: 'driver_city', driver_state: 'driver_state', driver_zip: 'driver_zip', has_charges:true, charge_towing: 120.00, charge_storage: 45.00, charge_admin: 25.00, tax: 0.74375, storage_rate: 15.00, mvd_inquiry_made: true, preparers_name: 'Sean Griffin', user: User.find_by_email('sgriffin@griffinassoc.com'))
